      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 max-w-7xl mx-auto mt-10">
        {teamMembers.map((member, index) => (
          ...
          >
            ...
            {/* Hover Card Overlay */}
            <div className="absolute inset-0 bg-black/70 flex flex-col justify-center items-start text-white px-12 opacity-0 group-hover:opacity-100 transition duration-300">
