...
//     >
//       {/* Gradient Overlay */}
//       <div className="absolute inset-0 bg-gradient-to-r from-green-500/90 to-[#97DD60]"></div>

//       {/* Content */}
//       <div className="relative py-20 md:py-32 text-white">
...
export default function Vission() {
  ...
  return (
    ...
    >
      {/* Gradient Overlay */}
      <div className="absolute inset-0 bg-gradient-to-r from-green-500/90 to-[#97DD60]" />
            ...
            {[
              {
                title: "Our Mission",
                text:
                  "At iLMiFY, our mission is to empower businesses by providing innovative digital solutions that drive growth and success. We deliver high-quality digital experiences tailored to each client.",
              },
              {
                title: "Our Vision",
                text:
                  "Our vision is to become a global leader in digital transformation through cutting-edge technology, creativity, and long-term client relationships.",
              },
              {
                title: "Our Values",
                text:
                  "We prioritize creativity, collaboration, and integrity. Our values guide every project and ensure quality, innovation, and meaningful impact.",
              },
              {
                title: "Our Approach",
                text:
                  "We listen, strategize, design, and build with purpose. Every solution aligns with business goals and delivers measurable results.",
              },
            ].map((item, index) => (
              <motion.div
                key={index}
