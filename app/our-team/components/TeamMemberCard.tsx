    ...
    >
      ...
      <div className="w-full  md:w-1/2 px-4 ">
        <div className="relative group h-full">
          ...
          <motion.div
            className="absolute inset-0 bg-linear-to-r from-[#0ddaa0] to-[#8ce064] rounded-xl blur-2xl -z-10"
            animate={{
          ...
          >
            ...
            >
              ...
              <p className="text-sm font-semibold text-transparent bg-clip-text bg-linear-to-r from-[#0ddaa0] to-[#8ce064]">
                {member.experience}
              </p>
            </motion.div>
          </motion.div>
      ...
      <div className="w-full md:w-1/2 flex flex-col items-center justify-center relative md:px-4 py-8">
        ...
        >
          {/* Outer Pulse Circle */}
          <motion.div
            className="absolute inset-5 rounded-full bg-linear-to-r from-[#0ddaa0] to-[#8ce064]"
          ...
          {/* Avatar Circle */}
          <div className="relative w-60 h-60 rounded-full bg-linear-to-r from-[#0ddaa0] to-[#8ce064] p-1 overflow-hidden shadow-2xl">
            {/* Logo Background */}
