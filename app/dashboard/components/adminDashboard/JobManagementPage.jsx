...
//                 className="pl-10 pr-4 py-2.5 border rounded-xl w-full bg-white focus:ring-2 focus:ring-[#0ddaa0] outline-none"
...
//                     {/* 3-Dot Dropdown */}
//                     {activeMenu === job.id && (
//                       <div className="absolute right-12 -top-5 w-44 bg-white shadow-2xl border rounded-xl   animate-in fade-in zoom-in duration-100">
...
//                         <button onClick={() => { setEditingJob(job); setActiveMenu(null); }} className="w-full text-left px-4 py-1 text-sm hover:bg-gray-50 flex items-center gap-2"><Edit3 size={14}/> Edit Position</button>
