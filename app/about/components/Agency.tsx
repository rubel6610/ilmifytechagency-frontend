...
export default function Agency() {
  ...
  const fadeInRight = {
    ...
    visible: {
      opacity: 1,
      x: 0,
      transition: { duration: 0.8, ease: "easeOut" as const }, // ✅ Already fixed
    },
  };

  return (
    <div className="bg-[#F9F9F9]">
      <div className="max-w-400 mx-auto px-4 md:px-12 py-12 lg:py-24 grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-12 lg:items-center">
        {/* Left Content */}
