...
//   return (
//     <div className="px-4">
//       <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-350 mx-auto">
...
//               <div className="">
//                 <h1 className="text-xl lg:text-[28px] mb-2">{card.title}</h1>
//                 <p className="text-12px md:text-[12px] lg:text[18px]">{card.paragraph}</p>
//                 {card.paragraph2 && <p className="text-12px md:text-[12px] lg:text[20px]">{card.paragraph2}</p>}
//               </div>
//             </div>
//           );
//         })}
