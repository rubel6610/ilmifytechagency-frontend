        ...
        <div className="relative bg-white/80 backdrop-blur-xl rounded-3xl p-8 md:p-12 shadow-[0_20px_80px_-20px_rgba(16,185,129,0.15)] border border-white/60 overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="space-y-8" noValidate>
                        ...
                        <label
                          className={`absolute left-0 transition-all duration-300 pointer-events-none ${
                            formData[field.name] || focusedField === field.name
                              ? `top-0 text-xs font-medium ${validationErrors[field.name] ? "text-red-500" : "text-emerald-500"}`
                              : "top-4 text-gray-400"
                          }`}
                        >
                          {field.label}
            ...
            >
              <div className="relative mt-1">
                ...
                >
                  <motion.svg
                    ...
                    initial={{ opacity: 0, scale: 0 }}
                    animate={{
                      opacity: formData.saveInfo ? 1 : 0,
                      scale: formData.saveInfo ? 1 : 0,
                    }}
                    transition={{ duration: 0.2 }}
                  >
              ...
              <label htmlFor="saveInfo" className="text-gray-600 text-sm md:text-base cursor-pointer select-none leading-relaxed">
