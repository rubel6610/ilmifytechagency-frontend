...
const WhoWeAre = () => {
  ...
  return (
    <div className="bg-[#F9F9F9] py-16 md:py-24 px-6">
      <div
        ref={containerRef}
        className="relative flex flex-col xl:flex-row items-center justify-between max-w-400 mx-auto gap-12 xl:gap-0"
      >
        ...
        <div className="w-full xl:w-[40%] xl:pl-16 flex flex-col items-start">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="mt-10 px-12 py-4 bg-linear-to-r from-[#98e670] to-[#00d696] text-white font-bold rounded-full shadow-[0_10px_30px_rgba(0,195,137,0.4)] uppercase tracking-wider text-sm transition-all"
          >
            Read More
          </motion.button>
        </div>
