      ...
      <div className="max-w-400 mx-auto flex flex-col-reverse xl:flex-row items-center gap-12 px-5 md:px-8.75">
        ...
        >
          <div className="mb-6 mt-20 md:mt-0">
            ...
            >
              With{" "}
              <span className="text-[#00D9A6]">
                <TypingText text="Live Chat" />
              </span>{" "}
              <br />
          ...
          <div className="space-y-6 text-gray-600 text-lg leading-relaxed font-ubuntu">
            <motion.p variants={fadeInUpVariants}>
              At iLMIFY, we understand that exceptional customer service is
              crucial to building trust and long-lasting relationships. That’s
              why we offer Live Chat and 24/7 Support to ensure your needs are
              met at any time, day or night.
            </motion.p>
            <motion.p variants={fadeInUpVariants}>
              Our dedicated support team is always ready to assist you with any
              questions, concerns, or technical issues you may have. Whether you
              need real-time help with navigating your website, troubleshooting,
              or getting advice on our services, our live chat feature ensures
              you’ll never have to wait long for assistance.
            </motion.p>
          </div>
        </motion.div>
