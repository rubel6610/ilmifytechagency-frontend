...
const DigitalFutures = () => {
  return (
    <section 
      className="relative w-full h-[60vh] md:h-[50vh] flex items-center justify-center bg-fixed bg-cover bg-center bg-no-repeat overflow-hidden"
      style={{
        // Tomar image link
    ...
    >
      ...
      <div className="absolute inset-0 bg-linear-to-br from-green-400/40 to-emerald-600/90 mix-blend-multiply backdrop-blur-md z-0"></div>
      ...
      <div className="relative z-10 w-full h-1/3 flex items-center justify-center p-6">
        <div className="max-w-4xl text-center text-white">
          ...
          <p className="text-base md:text-lg font-medium opacity-95 max-w-2xl mx-auto">
